...
def attack(char_name: str, char_class: str) -> str:
    """Этот docstring описывает метод attack.
    И демонстрирует перенос строки
    документации.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Высчитывает кол-во заблокированного урона."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Этот docstring описывает умения персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Этот docstring предоставляет выбор персонажа."""
    approve_choice: str = ''
    char_class: str = ''
